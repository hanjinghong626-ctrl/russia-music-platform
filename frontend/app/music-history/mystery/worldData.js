          ...
          clueItems: [
            {
              ...
              name: "里姆斯基的课桌",
              icon: "📝",
              image: "/images/mystery/items/score_open.jpg",
              x: 50, y: 50,
            ...
            },
            {
              ...
              name: "教学笔记",
              icon: "📖",
              image: "/images/mystery/items/manuscript_book.jpg",
              x: 70, y: 55,
          ...
          clueItems: [
            {
              ...
              name: "斯塔索夫的旧文",
              icon: "📰",
              image: "/images/mystery/items/newspaper_old.jpg",
              x: 45, y: 50,
            ...
            },
            {
              ...
              name: "居伊的乐评",
              icon: "✍️",
              image: "/images/mystery/items/handwritten_notes.jpg",
              x: 65, y: 42,
          ...
          clueItems: [
            {
              ...
              name: "侍者的耳语",
              icon: "🤫",
              image: "/images/mystery/items/folded_note.jpg",
              x: 40, y: 60,
          ...
          clueItems: [
            {
              ...
              name: "宫廷演出记录",
              icon: "📜",
              image: "/images/mystery/items/official_document.jpg",
              x: 50, y: 50,
          ...
          clueItems: [
            {
              ...
              name: "可疑的木箱",
              icon: "📦",
              image: "/images/mystery/items/wooden_crate.jpg",
              x: 45, y: 55,
      ...
      buildings: [
        {
          ...
          clueItems: [
            ...
            },
            {
              ...
              name: "未寄出的信",
              icon: "✉️",
              image: "/images/mystery/items/letter_sealed.jpg",
              x: 65, y: 55,
            ...
            },
            {
              ...
              name: "半截蜡烛",
              icon: "🕯️",
              image: "/images/mystery/items/ink_bottle.jpg",
              x: 45, y: 60,
          ...
          clueItems: [
            {
              ...
              name: "火柴盒",
              icon: "🔥",
              image: "/images/mystery/items/matchbox.jpg",
              x: 35, y: 55,
          ...
          clueItems: [
            {
              ...
              name: "凉亭密信",
              icon: "💌",
              image: "/images/mystery/items/letter_bundle.jpg",
              x: 50, y: 50,
          ...
          clueItems: [
            {
              ...
              name: "雕像底座刻字",
              icon: "🔍",
              image: "/images/mystery/items/engraving_rub.jpg",
              x: 50, y: 70,
