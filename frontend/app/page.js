    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-8">
              ...
              <Link href="/music-history/glossary" className="text-gray-600 hover:text-primary-700 transition-colors font-medium flex items-center gap-1">
                <span>📖</span>
                百科
              </Link>
      ...
      <section className="py-16 bg-gradient-to-br from-emerald-50 to-teal-50">
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            <div className="md:flex">
              <div className="md:w-2/5 bg-gradient-to-br from-emerald-600 to-teal-700 p-8 flex flex-col justify-center items-center text-white">
                <div className="text-7xl mb-4">🎼</div>
                <h3 className="text-2xl font-bold mb-2 text-center">练声曲库</h3>
                <p className="text-emerald-200 text-sm text-center italic mb-6">
                  Vocal Exercises Library
                </p>
                <span className="px-4 py-2 bg-white/20 rounded-full text-sm">
                  14位作曲家 · 500+作品
                </span>
              ...
              <div className="md:w-3/5 p-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">声乐演唱专业核心资源</h2>
                <p className="text-gray-600 mb-6">
                  收录阿布特、孔科内、瓦卡伊、博尔东尼、兰佩尔蒂等大师的经典练声曲教材。按声部分类、难度分级，助力系统训练呼吸支持、声区统一与音色变化。
                </p>
                <div className="flex gap-3 flex-wrap mb-4">
                  <span className="px-3 py-1 bg-emerald-100 text-emerald-700 rounded-full text-xs">公版作品</span>
                  <span className="px-3 py-1 bg-emerald-100 text-emerald-700 rounded-full text-xs">PDF原版</span>
                  <span className="px-3 py-1 bg-emerald-100 text-emerald-700 rounded-full text-xs">柴院推荐</span>
                  <span className="px-3 py-1 bg-emerald-100 text-emerald-700 rounded-full text-xs">6种声部</span>
                </div>
                <Link
                  href="/vocal-exercises"
                  className="inline-block bg-emerald-600 text-white px-8 py-3 rounded-lg hover:bg-emerald-700 transition-colors font-medium shadow-lg"
                >
                  进入练声曲库 →
                </Link>
              </div>
